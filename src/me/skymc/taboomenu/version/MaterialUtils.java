...
public enum MaterialUtils {
    ...
    private int data;
    private static HashMap<String, MaterialUtils> cachedSearch = new HashMap<>();

    MaterialUtils(String material, int data ){
        this.material = material;
        this.data = data;
    }

    public static MaterialUtils requestMaterial(String name, byte data){
        ...
        for(MaterialUtils mat:MaterialUtils.values()){
            if(name.toUpperCase().equals(mat.material) && ((byte)mat.data) == data){
                cachedSearch.put(mat.material+","+data,mat);
                return mat;
            }
        }
        return null;
    ...
    public static Material getMaterial(String name){
        ...
        try{
            ...
            String[] materialInfo = name.split(":");

            if(materialInfo.length==1)
                mat = requestMaterial(name,(byte) 0);
            else
                mat = requestMaterial(materialInfo[0],(byte) Integer.parseInt(materialInfo[1]));

            if (mat!=null)
                return Material.valueOf(mat.name());
        }
